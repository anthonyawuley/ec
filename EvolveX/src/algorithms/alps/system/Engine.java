	...
	public void layeredEvolutionALPS(ArrayList<Layer> layers)
	{
		...
		*/
		while(Engine.completeGenerationalCount <= layers.get(0).getParameters().getEvaluations())
		{
	      ...
	      {  //System.out.println("i came here INIIT");
	    	 alps.index =  j; //only modify the index
				 ...
				 { //System.out.println("DEFAULT "+ j+ " ::: "+ Engine.completeGenerationalCount +" .... "+layers.get(j).getMaxAge());
	    		...
	    		{   //System.out.println("OTHER "+ j+ " ::: "+ Engine.completeGenerationalCount +" .... "+layers.get(j).getMaxAge());
